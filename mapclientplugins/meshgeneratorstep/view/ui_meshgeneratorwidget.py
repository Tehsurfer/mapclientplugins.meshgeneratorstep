...
class Ui_MeshGeneratorWidget(object):
    def setupUi(self, MeshGeneratorWidget):
        ...
        self.dockWidget.setMinimumSize(QtCore.QSize(353, 225))
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -323, 316, 1098))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.identifier_label_2 = QtGui.QLabel(self.identifier_frame)
        self.identifier_label_2.setObjectName("identifier_label_2")
        self.verticalLayout_4.addWidget(self.identifier_label_2)
        ...
        self.BlackfynnOptions_GroupBox = QtGui.QGroupBox(self.scrollAreaWidgetContents_2)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.BlackfynnOptions_GroupBox.sizePolicy().hasHeightForWidth())
        self.BlackfynnOptions_GroupBox.setSizePolicy(sizePolicy)
        self.BlackfynnOptions_GroupBox.setObjectName("BlackfynnOptions_GroupBox")
        self.verticalLayout_8 = QtGui.QVBoxLayout(self.BlackfynnOptions_GroupBox)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.Login_groupBox = QtGui.QGroupBox(self.BlackfynnOptions_GroupBox)
        self.Login_groupBox.setObjectName("Login_groupBox")
        self.gridLayout_5 = QtGui.QGridLayout(self.Login_groupBox)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.submitButton = QtGui.QPushButton(self.Login_groupBox)
        self.submitButton.setObjectName("submitButton")
        self.gridLayout_5.addWidget(self.submitButton, 3, 1, 1, 1)
        self.api_secret = QtGui.QLineEdit(self.Login_groupBox)
        self.api_secret.setEchoMode(QtGui.QLineEdit.Normal)
        self.api_secret.setPlaceholderText("")
        self.api_secret.setObjectName("api_secret")
        self.gridLayout_5.addWidget(self.api_secret, 2, 1, 1, 1)
        self.api_key = QtGui.QLineEdit(self.Login_groupBox)
        self.api_key.setObjectName("api_key")
        self.gridLayout_5.addWidget(self.api_key, 1, 1, 1, 1)
        self.verticalLayout_8.addWidget(self.Login_groupBox)
        self.displayEEGAnimation_checkBox = QtGui.QCheckBox(self.BlackfynnOptions_GroupBox)
        self.displayEEGAnimation_checkBox.setObjectName("displayEEGAnimation_checkBox")
        self.verticalLayout_8.addWidget(self.displayEEGAnimation_checkBox)
        self.pushButton = QtGui.QPushButton(self.BlackfynnOptions_GroupBox)
        self.pushButton.setObjectName("pushButton")
        self.verticalLayout_8.addWidget(self.pushButton)
        self.scale_label_2 = QtGui.QLabel(self.BlackfynnOptions_GroupBox)
        self.scale_label_2.setObjectName("scale_label_2")
        self.verticalLayout_8.addWidget(self.scale_label_2)
        self.dataSetName_lineInput = QtGui.QLineEdit(self.BlackfynnOptions_GroupBox)
        self.dataSetName_lineInput.setObjectName("dataSetName_lineInput")
        self.verticalLayout_8.addWidget(self.dataSetName_lineInput)
        self.scale_label_3 = QtGui.QLabel(self.BlackfynnOptions_GroupBox)
        self.scale_label_3.setObjectName("scale_label_3")
        self.verticalLayout_8.addWidget(self.scale_label_3)
        self.displaySurfaces_frame_2 = QtGui.QFrame(self.BlackfynnOptions_GroupBox)
        self.displaySurfaces_frame_2.setFrameShape(QtGui.QFrame.StyledPanel)
        self.displaySurfaces_frame_2.setFrameShadow(QtGui.QFrame.Raised)
        self.displaySurfaces_frame_2.setObjectName("displaySurfaces_frame_2")
        self.horizontalLayout_5 = QtGui.QHBoxLayout(self.displaySurfaces_frame_2)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.verticalLayout_8.addWidget(self.displaySurfaces_frame_2)
        self.timeSeries_lineInput = QtGui.QLineEdit(self.BlackfynnOptions_GroupBox)
        self.timeSeries_lineInput.setObjectName("timeSeries_lineInput")
        self.verticalLayout_8.addWidget(self.timeSeries_lineInput)
        self.verticalLayout_3.addWidget(self.BlackfynnOptions_GroupBox)
    ...
    def retranslateUi(self, MeshGeneratorWidget):
        ...
        self.identifier_label_2.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Identifier", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.BlackfynnOptions_GroupBox.setTitle(QtGui.QApplication.translate("MeshGeneratorWidget", "Blackfynn EEG data", None, QtGui.QApplication.UnicodeUTF8))
        self.Login_groupBox.setTitle(QtGui.QApplication.translate("MeshGeneratorWidget", "Blackfynn Login", None, QtGui.QApplication.UnicodeUTF8))
        self.submitButton.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Submit", None, QtGui.QApplication.UnicodeUTF8))
        self.api_secret.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "API Secret", None, QtGui.QApplication.UnicodeUTF8))
        self.api_key.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "API Key", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.scale_label_2.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Data set name", None, QtGui.QApplication.UnicodeUTF8))
        self.dataSetName_lineInput.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "name", None, QtGui.QApplication.UnicodeUTF8))
        self.scale_label_3.setText(QtGui.QApplication.translate("MeshGeneratorWidget", "Time series name", None, QtGui.QApplication.UnicodeUTF8))
